...
$picPath = !empty($driver['photo_path']) ? $driver['photo_path'] : "../images/default-profile.png";
...
<div class="content p-4">
  <h3 class="fw-bold mb-4">Welcome back, <?= htmlspecialchars($driver['first_name']) ?>!</h3>
  ...
  <div class="row g-4">
    <div class="col-md-6">
      <div class="card shadow-sm p-4">
        ...
        <p><strong>License Number:</strong> <?= htmlspecialchars($driver['license_number'] ?? 'Not Set') ?></p>
        <p><strong>Address:</strong> <?= htmlspecialchars($driver['address'] ?? 'Not Set') ?></p>
      </div>
    </div>
    <div class="col-md-6">
